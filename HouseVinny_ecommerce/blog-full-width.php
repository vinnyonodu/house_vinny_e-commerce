    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">House Vinny Blog</h3>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row mb-n6">
                            <div class="col-xl-4 col-md-6 col-12 mb-6">
                                ...
                                <div class="blog-list blog-grid-single-item blog-color--golden" data-aos="fade-up"
                                    ...
                                    <div class="image-box">
                                        <a>
                                            <img class="img-fluid" src="assets/images/blog/iPhone-15-Pro (1).jpg"
                                                alt="blog post 1">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <ul class="post-meta">
                                            <li>POSTED BY : <a class="author">Vincent Onodu</a></li>
                                            <li>ON : <a class="date">JULY 09, 2023</a></li>
                                        </ul>
                                        ...
                                        <p>Apple releases an update as regards the much anticipated multi colours for the 
                                            incoming Iphone 25 pro max, yet to be released on the 25th of December, 2023</p>
                                        <!-- <a class="read-more-btn icon-space-left">Read More <span class="icon"><i
                            ...
                            <div class="col-xl-4 col-md-6 col-12 mb-6">
                                ...
                                <div class="blog-list blog-grid-single-item blog-color--golden" data-aos="fade-up"
                                        ...
                                        <div class="blog-list-slider swiper-container">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="blog-list-slider-img swiper-slide"><img class="img-fluid"
                                                        src="assets/images/blog/macbook (1).jpg" alt="blog post 2i">
                                                </div>
                                                <div class="blog-list-slider-img swiper-slide"><img class="img-fluid"
                                                        src="assets/images/blog/m1-chip-macbook-air-pro (1).jpg" alt="blog post 2ii">
                                                </div>
                                            </div>
                                    ...
                                    <div class="content">
                                        <ul class="post-meta">
                                            <li>POSTED BY : <a class="author">Vincent Onodu</a></li>
                                            <li>ON : <a class="date">JULY 08, 2023</a></li>
                                        </ul>
                                        <h6 class="title"><a>M1 Chip Introduced</a>
                                        </h6>
                                        <p>MacBook Air with M1 is an incredibly portable laptop - it's nimble and quick, with a silent, 
                                            fanless design and a beautiful Retina display. </p>
                            ...
                            <div class="col-xl-4 col-md-6 col-12 mb-6">
                                ...
                                <div class="blog-list blog-grid-single-item blog-color--golden" data-aos="fade-up"
                                    ...
                                    <div class="blog-video-box">
                                        <img class="img-fluid" src="assets/images/blog/samsung-galaxy-watch.jpg"
                                            alt="blog post 3">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Samsung Galaxy Watch 46mm R800 Silver from Samsung is more than just a typical smartwatch, 
                                            it's a time piece. Choose from multiple elegant style watch faces.</p>
                                        <!-- <a class="read-more-btn icon-space-left">Read More <span class="icon"><i
                                                    class="ion-ios-arrow-thin-right"></i></span></a> -->
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-md-6 col-12 mb-6">
                                ...
                                <div class="blog-list blog-grid-single-item blog-color--golden" data-aos="fade-up"
                                    ...
                                    <div class="image-box">
                                        <a>
                                            <img class="img-fluid" src="assets/images/blog/applevr (1).jpg"
                                                alt="blog post 4">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <ul class="post-meta">
                                            <li>POSTED BY : <a class="author">Vincent Onodu</a></li>
                                            <li>ON : <a class="date">JULY 07, 2023</a></li>
                                        </ul>
                    ...
                    <div class="page-pagination text-center" data-aos="fade-up" data-aos-delay="0">
                        <ul>
                            ...
                            <li><a>2</a></li>
                            <li><a>3</a></li>
                            <li><a><i class="ion-ios-skipforward"></i></a></li>
                        </ul>
                    </div> <!-- End Pagination -->
                </div>
            </div>
