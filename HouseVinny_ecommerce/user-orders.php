...
$user_session = $_SESSION['id']; // to store session id in a $user_session variable
...
$orders_sql = "SELECT * FROM orders WHERE user_id = '$user_session'";
...
function_alert("Login to view orders. Click OK to go to Login page!");
}
                    ...
                    <div class="col-12">
                        <div class="table_desc">
                            <div class="table_page table-responsive">
                                <h2>Recent Completed Orders</h2><br>
                                <table>
                                    <!-- Start Cart Table Head -->
                                    <thead>
                                        <tr>
                                            <th class="product_thumb">SN </th>
                                            <th class="product_thumb">Item </th>
                                            <th class="product_name">Item Image</th>
                                            <th class="product-price">Price (per unit)</th>
                                            <th class="product-price">Quantity Ordered</th>
                                            <th class="product-price">Date Ordered</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr>
                                                <td class="product_name"><a><?php echo $sn; $sn = $sn +1; ?></a></td>
                                                <td class="product_name"><a><?php echo $orders_row['item_title']; ?></a></td>
                                                <td class="product_thumb"><a><img
                                                            src="assets/images/product/default/home-3/<?php echo $orders_row['item_image']?>"
                                                            alt="item 1 on cart"></a></td>
                                                <td class="product-price">&pound;<?php echo $orders_row['item_price']?>.00</td>
                                                <td class="product_quantity"><label></label> <input min="1"
                                                        max="100" value="<?php echo $orders_row['quantity']?>" type="number" readonly></td>
                                                <td class="product-price"><?php echo $orders_row['order_date']?>.00</td>                                       
